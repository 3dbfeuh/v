if shared.VapeExecuted then
	...
	local function getcustomassetfunc(path)
		if not isfile(path) then
			...
			local req = requestfunc({
				Url = "https://raw.githubusercontent.com/3dbfeuh/v/main/contents/"..path:gsub(customdir .. "assets", "assets"),
				Method = "GET"
			})
	...
	searchbaricon.Image = getcustomassetfunc(customdir .. "assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = getcustomassetfunc(customdir .. "assets/WindowBlur.png")
	...
	hoverboxshadow.Image = getcustomassetfunc(customdir .. "assets/WindowBlur.png")
	...
	api["CreateMainWindow"] = function()
		...
		windowshadow.Image = getcustomassetfunc(customdir .. "assets/WindowBlur.png")
		...
		windowlogo1.Image = getcustomassetfunc(customdir .. "assets/VapeLogo1.png")
		...
		windowlogo2.Image = getcustomassetfunc(customdir .. "assets/VapeLogo2.png")
		...
		settingswheel.Image = getcustomassetfunc(customdir .. "assets/SettingsWheel1.png")
		...
		settingsexit.Image = getcustomassetfunc(customdir .. "assets/ExitIcon1.png")
		...
		overlaysicon.Image = getcustomassetfunc(customdir .. "assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = getcustomassetfunc(customdir .. "assets/ExitIcon1.png")
		...
		overlaysbutton.Image = getcustomassetfunc(customdir .. "assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = getcustomassetfunc(customdir .. "assets/BackIcon.png")
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = getcustomassetfunc(customdir .. "assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = getcustomassetfunc(customdir .. "assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = getcustomassetfunc(customdir .. "assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = getcustomassetfunc(customdir .. "assets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindimg.Image = getcustomassetfunc(customdir .. "assets/KeybindIcon.png")
			...
			bindtext2.Image = getcustomassetfunc(customdir .. "assets/BindBackground.png")
			...
			bindbkg.MouseEnter:connect(function() 
				bindimg.Image = getcustomassetfunc(customdir .. "assets/PencilIcon.png") 
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = getcustomassetfunc(customdir .. "assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = getcustomassetfunc(customdir .. "assets/ColorSlider1.png")
			...
			sliderapi["SetValue"] = function(val)
				slider3.Image = (sliderapi["RainbowValue"] and getcustomassetfunc(customdir .. "assets/ColorSlider2.png") or getcustomassetfunc(customdir .. "assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and getcustomassetfunc(customdir .. "assets/RainbowIcon2.png") or getcustomassetfunc(customdir .. "assets/RainbowIcon1.png"))
	...
	api["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = getcustomassetfunc(customdir .. "assets/PinButton.png")
		...
		optionsbutton.Image = getcustomassetfunc(customdir .. "assets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = getcustomassetfunc(customdir .. "assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = getcustomassetfunc(customdir .. "assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = getcustomassetfunc((argstable["Name"] == "ProfilesList" and customdir .. "assets/TextBoxBKG2.png" or customdir .. "assets/TextBoxBKG.png"))
				...
				addbutton.Image = getcustomassetfunc(customdir .. "assets/AddItem.png")
				...
				textapi["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textapi["ObjectList"]) do
						...
						deletebutton.Image = getcustomassetfunc(customdir .. "assets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = getcustomassetfunc(customdir .. "assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = getcustomassetfunc(customdir .. "assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	api["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = getcustomassetfunc(customdir .. "assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = getcustomassetfunc(customdir .. "assets/MoreButton1.png")
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = getcustomassetfunc(customdir .. "assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = getcustomassetfunc(customdir .. "assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = getcustomassetfunc(customdir .. "assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["Players"] = windowapi["CreateButton"]({
					...
					["Icon"] = customdir .. "assets/TargetIcon1.png",
					["IconSize"] = 15,
				...
				buttonreturned["NPCs"] = windowapi["CreateButton"]({
					...
					["Icon"] = customdir .. "assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowapi["CreateButton"]({
					...
					["Icon"] = customdir .. "assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = customdir .. "assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonapi["CreateColorSlider"] = function(argstable)
				...
				sliderexpand.Image = getcustomassetfunc(customdir .. "assets/HoverArrow.png")
				sliderexpand.Parent = frame
				sliderexpand.MouseEnter:connect(function()
					sliderexpand.Image = getcustomassetfunc(customdir .. "assets/HoverArrow2.png")
				end)
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = getcustomassetfunc(customdir .. "assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = getcustomassetfunc(customdir .. "assets/SliderArrow1.png")
	...
	api["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = getcustomassetfunc(customdir .. "assets/SettingsWheel2.png")
	...
	api["CreateNotification"] = function(top, bottom, duration, customicon)
			...
			image.Image = getcustomassetfunc(customdir .. "assets/NotificationBackground.png")
			...
			frame2.ZIndex = 2
			frame2.Image = getcustomassetfunc(customdir .. "assets/NotificationBar.png")
			frame2.BorderSizePixel = 0
			frame2.Parent = image
			local icon = Instance.new("ImageLabel")
			icon.Name = "IconLabel"
			icon.Image = getcustomassetfunc(customicon and customdir .. ""..customicon or customdir .. "assets/InfoNotification.png")
